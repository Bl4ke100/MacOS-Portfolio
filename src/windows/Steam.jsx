    ...
    <div className="w-full h-full flex flex-col bg-[#171a21] text-[#c7d5e0] font-sans">
        ...
        <div className="flex-1 overflow-y-auto p-6 scrollbar-hide relative">
            ...
            <div className="grid grid-cols-4 gap-3 mb-10">
                ...
                <div className="bg-[#1b2838] p-3 rounded-xl border border-white/5 flex flex-col justify-between shadow-lg">
                    <Gamepad2 size={16} className="text-yellow-500 mb-2" />
                    <p className="text-xl font-black text-white leading-none">{data.avg_playtime} <span className="text-[10px] text-gray-500 font-bold">HRS</span></p>
                    <p className="text-[9px] uppercase font-bold tracking-widest text-gray-400 mt-1">Avg per Game</p>
                </div>
                <div className="bg-[#1b2838] p-3 rounded-xl border border-white/5 flex flex-col justify-between shadow-lg">
